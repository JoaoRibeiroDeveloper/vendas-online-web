...
describe('Test Button', () => {
  it('should render', () => {
    ...
    expect(
      getByTestId(ProductInsertTestIdEnum.PRODUCT_INPUT_IMAGE),
    ).toBeDefined();
    expect(
      getByTestId(ProductInsertTestIdEnum.PRODUCT_INPUT_NAME),
    ).toBeDefined();
    expect(
      getByTestId(ProductInsertTestIdEnum.PRODUCT_INPUT_PRICE),
    ).toBeDefined();
    expect(
      getByTestId(ProductInsertTestIdEnum.PRODUCT_INPUT_SELECT),
    ).toBeDefined();
    expect(
